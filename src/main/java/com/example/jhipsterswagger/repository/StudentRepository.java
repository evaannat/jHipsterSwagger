...
public interface StudentRepository extends JpaRepository<Student, Long> {
    ...
    @Query(value = "select distinct student from Student student left join fetch student.interests",
    ...
    @Query("select distinct student from Student student left join fetch student.interests")
    List<Student> findAllWithEagerRelationships();

    @Query("select student from Student student left join fetch student.interests where student.id =:id")
